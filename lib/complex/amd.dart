...
Int32List amd(int order, Matrix A) {
  ...
  if (P == null || W == null || !sprealloc(C, t)) {
    return (_idone(P, C, W, false));
  }
  len = W;
  nv = W;
  int nv_offset = n + 1;
  ...
  {
    if (Cp[i] == -1) {
      k = tdfs(i, k, head, head_offset, next, next_offset, P, 0, w, w_offset);
    }
  }
  return (_idone(P, C, W, true));
}
