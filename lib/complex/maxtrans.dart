 ...
 */
void _cs_augment(int k, DZcs A, Int32List jmatch, int jmatch_offset, Int32List cheap, int cheap_offset,
	    Int32List w, int w_offset, Int32List js, int js_offset, Int32List is_, int is_offset, Int32List ps, int ps_offset)
{
	int p, i = -1, head = 0, j ;
	...
	if (found) for (p = head ; p >= 0 ; p--) jmatch [jmatch_offset + is_ [is_offset + p]] = js [js_offset + p] ;
}
...
Int32List cs_maxtrans(DZcs A, int seed)		/*[jmatch [0..m-1]; imatch [0..n-1]]*/
{
	...
	Int32List Ap, jimatch, w, cheap, js, is_,
