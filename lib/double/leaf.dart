...
/// ancestor (lca).
int cs_leaf(int i, int j, Int32List first, int first_offset, Int32List maxfirst,
            int maxfirst_offset, Int32List prevleaf, int prevleaf_offset,
            Int32List ancestor, int ancestor_offset, Int32List jleaf) {
