...
Dcsn cs_qr(Dcs A, Dcss S) {
    ...
    rnz = S.unz;
    leftmost = S.leftmost;
    w = new List<int>.filled(m2 + n, 0); /* get int workspace */
    x = new List<double>.filled(m2, 0.0); /* get double workspace */
    ...
    N.B = Beta = new List<double>.filled(n, 0.0); /* allocate result Beta */
    Rp = R.p;
    Ri = R.i;
    Rx = R.x;
    Vp = V.p;
