...
List<int> cs_maxtrans(Dcs A, int seed) /*[jmatch [0..m-1]; imatch [0..n-1]]*/
{
    ...
    Ap = A.p;
    Ai = A.i;
    w = jimatch = new List<int>(m + n); /* allocate result */
    ...
    w = new List<int>(5 * n); /* get workspace */
    cheap = w;
    int cheap_offset = n;
    js = w;
    int js_offset = 2 * n;
    ...
    {
        cs_augment(q != null ? q[k] : k, C, jmatch, jmatch_offset, cheap, cheap_offset, w, 0, js, js_offset, _is,
